...
<html>
  ...
  <body>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
      ...
      >
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <!-- MODAL/BUTTON LOGIN/SIGNUP -->
          <article>
            <!-- <label class="btn btn-primary bg-gray-500" for="modal-1"
              >LOGIN</label
            > -->
            <label
              class="btn text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700"
              for="modal-1"
            >
              <svg
                aria-hidden="true"
            ...
            <div class="modal" id="modal-1-content">
                ...
                <section>
                  <form action="/login" method="post">
                    ...
                    <div class="form-group" >
                      ...
                      <div class="form-field pt-5">
                        <div class="form-control justify-between">
                          <input type="submit" class="btn btn-primary w-full text-blue-500" value="Sign in">
                          <!-- <button
                            type="button"
                            class="btn btn-primary w-full text-blue-500"
                          >
                            Sign in
                          </button> -->
                        </div>
                  ...
                  >
                    ...
                    <a
                      ...
                      data-target="#modal-2"
                      onclick="document.getElementById('modal-1').checked = false; document.getElementById('modal-2').checked = true;"
                      >Sign up</a
                    >
                  </div>
                </section>
            ...
            <div class="modal" id="modal-2-content">
                ...
                <section>
                  <form action="/register" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-field pt-5">
                        <div class="form-control justify-between">
                          <input type="submit" class="btn btn-primary w-full text-blue-500" value="Sign up">
                          <!-- <button
                            type="button"
                            class="btn btn-primary w-full text-blue-500"
                          >
                    ...
                    >
                      ...
                      <a
                        ...
                        href="#"
                        class="link link-primary text-xs"
                        onclick="document.getElementById('modal-2').checked = false; document.getElementById('modal-1').checked = true;"
                        >Sign in</a
                      >
                    </div>
                  </form>
          ...
          <!-- END OF MODAL/BUTTON LOGIN/SIGNUP -->
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        >
          We believe that every moment is an opportunity for you to win and
          experience the thrill of victory. So, step inside and prepare for your
          winning moment, where luck and fortune are on your side.
        </p>
        <div
    ...
    <div id="gallery" class="relative w-full" data-carousel="slide">
      ...
      <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img
            src="https://i.ibb.co/pXcx4f8/392275dee0f43bd41c33f8e8d62b4f00.jpg"
        ...
        >
          <img
            src="https://i.ibb.co/N1TBSRG/cc705b5e5c35fd947f313bd9262d8c25.jpg"
            class="absolute block max-w-full h-auto -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt=""
          />
        </div>
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img
            src="https://i.ibb.co/R9tnYQ0/c81d5d6eaff7278b9ff7c3dc56326da8.jpg"
            class="absolute block max-w-full h-auto -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt=""
          />
        </div>
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        <p
          class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400"
        >
          At our casino, teamwork is at the heart of everything we do. Our
          dedicated team works together to ensure that every deal is fair, every
          spin is thrilling, and every player enjoys a top-notch gaming
          experience. We believe in the power of collaboration to create
          excellence, making every visit to our casino unforgettable.
        </p>
      </div>
    </section>
    <!-- END OF OUR TEAM -->
  ...
  <div class="rounded-[2rem] overflow-hidden h-[426px] md:h-[654px] bg-white dark:bg-gray-800">
    ...
    <!-- <div class="mx-auto dark:bg-gray-900 flex w-full max-w-sm flex-col gap-6">
      <div class="flex flex-col items-center">
        <h1 class="text-3xl font-extrabold">Get Early Access</h1>
...
-->
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-lg text-center">
        ...
        <p class="mt-4 text-gray-500">Get your waitlist access for the apps</p>
      </div>

      <form action="/download" class="mx-auto mb-0 mt-8 max-w-md space-y-4">
        <div>
        ...
        <div class="flex items-center justify-between">
          ...
          <input type="submit" class="inline-block rounded-lg bg-blue-500 px-5 py-3 text-sm font-medium text-white" value="Get access">
        </div>
      </form>
    </div>
    <!-- END OF FORM WAITLIST -->
    ...
    <footer class="bg-white rounded-lg shadow m-4 dark:bg-gray-800">
      ...
      >
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
          >© 2023
          <a href="https://flowbite.com/" class="hover:underline">MamadCorp™</a
          >. All Rights Reserved.
        </span>
        <ul
...
<?php /**PATH C:\Users\pan\Downloads\weblanjut\weblanjut\resources\views/dashboard.blade.php ENDPATH**/ ?>